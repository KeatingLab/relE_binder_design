...
#########################################
# Set these values
repo_dir=/data1/groups/keatinglab/swans/repos/peptide_binder_design
nameandsequencecsv=/data1/groups/keatinglab/swans/binderDesign_relE/analysis/combined_analysis/final_library_aaseqs.txt
template_file=$repo_dir/examples/09_aminoToNucleic/1_codonOptimizeProteinSequences/DNAWORKS_template.inp
dnaworks=/data1/groups/keatinglab/swans/repos/DNAWorks/dnaworks
