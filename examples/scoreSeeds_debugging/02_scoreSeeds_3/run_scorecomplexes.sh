...
# dataset=../02_scoreSeeds_2/7_connectFragments_relBhelix-2seeds_memfixed_topologyfixed_fusedDB.pdb
dataset=7_connectFragments_relBhelix-2seeds_memfixed_topologyfixed_fusedDB.pdb
