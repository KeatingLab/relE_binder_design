...
do
	...
	do
		...
		. /home/gridsan/fbirnbaum/TERMinatorscripts/models/train/submit_train.sh /home/gridsan/mlu/keatinglab_shared/mlu/bcl2/term_features_with_sortcery /home/gridsan/fbirnbaum/TERMinatorhparams/model/ablate_singleton_features.json /home/gridsan/fbirnbaum/TERMinatorhparams/run/finetune_sortcery_noreg_${j}.json /home/gridsan/mlu/keatinglab_shared/mlu/tuning/include_nlcpl/${2}/run${i}_${j} /home/gridsan/mlu/keatinglab_shared/mlu/tuning/include_nlcpl/${2}/run${i}_${j} 12 train validation test
	done
done
