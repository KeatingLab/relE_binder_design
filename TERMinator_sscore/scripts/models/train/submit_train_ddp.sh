...
VALIDATION=$9
TEST=${10}
echo "$DATANAME $RUNNAME $OUTPUTDIR $LOGDIR"
...
sed \
  ...
  >bash_files/run_${DATANAME}_${RUNNAME}_run0_ddp.sh
jid0=$(sbatch --parsable bash_files/run_${DATANAME}_${RUNNAME}_run0_ddp.sh)
echo $jid0