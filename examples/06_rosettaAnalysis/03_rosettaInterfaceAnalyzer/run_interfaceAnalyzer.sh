...
echo $intAnaBin -in:file:silent $silent_file -out:file:score_only score.sc -add_regular_scores_to_scorefile -compute_packstat -packstat::oversample $packstat_oversample -tracer_data_print
$intAnaBin -in:file:silent $silent_file -out:file:score_only score.sc -add_regular_scores_to_scorefile -compute_packstat -packstat::oversample $packstat_oversample -tracer_data_print
