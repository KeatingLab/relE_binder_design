...
==========
    ...
    flex_type : str, default=None
        Type of data to use in Flex Information Condenser
...
DEFAULT_MODEL_HPARAMS = {
    ...
    'sscore_from_embedding': 'self_edge',
    'sscore_module':'linear',
    'sscore_module_nhidden':64,
...
DEFAULT_TRAIN_HPARAMS = {
    ...
    'finetune_nlcpl': False,
    'finetune_sscore': False,
    'finetune_lr': 1e-6,
    'noise_level': 0,
